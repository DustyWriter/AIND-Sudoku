...
class TestDiagonalSudoku(unittest.TestCase):
    ...
    diagonal_grid_2 = '4.......3..9.........1...7.....1.8.....5.9.....1.2.....3...5.........7..7.......8'
    solved_diag_sudoku2 = {'A1': '4', 'A2': '1', 'A3': '7', 'A4': '9', 'A5': '5', 'A6': '6', 'A7': '2', 'A8': '8', 'A9': '3','B1': '3',
                           'B2': '2', 'B3': '9', 'B4': '4', 'B5': '7', 'B6': '8', 'B7': '6', 'B8': '1', 'B9': '5', 'C1': '6',
                           'C2': '8', 'C3': '5', 'C4': '1', 'C5': '3', 'C6': '2', 'C7': '9', 'C8': '7', 'C9': '4', 'D1': '2',
                           'D2': '9', 'D3': '6', 'D4': '3', 'D5': '1', 'D6': '4', 'D7': '8', 'D8': '5', 'D9': '7', 'E1': '8',
                           'E2': '7', 'E3': '3', 'E4': '5', 'E5': '6', 'E6': '9', 'E7': '4', 'E8': '2', 'E9': '1', 'F1': '5',
                           'F2': '4', 'F3': '1', 'F4': '8', 'F5': '2', 'F6': '7', 'F7': '3', 'F8': '6', 'F9': '9', 'G1': '9',
                           'G2': '3', 'G3': '2', 'G4': '7', 'G5': '8', 'G6': '5', 'G7': '1', 'G8': '4', 'G9': '6', 'H1': '1',
                           'H2': '5', 'H3': '8', 'H4': '6', 'H5': '4', 'H6': '3', 'H7': '7', 'H8': '9', 'H9': '2', 'I1': '7', 'I2': '6',
                           'I3': '4', 'I4': '2', 'I5': '9', 'I6': '1', 'I7': '5', 'I8': '3', 'I9': '8'}

    diagonal_grid_3 = '....29.......7......3...8..........735.....161..........6...4......6.......83....'
    solved_diag_sudoku3 = {'A1': '7', 'A2': '8', 'A3': '4', 'A4': '5', 'A5': '2', 'A6': '9', 'A7': '6', 'A8': '3', 'A9': '1','B1': '6',
                           'B2': '2', 'B3': '1', 'B4': '3', 'B5': '7', 'B6': '8', 'B7': '9', 'B8': '5', 'B9': '4', 'C1': '5',
                           'C2': '9', 'C3': '3', 'C4': '6', 'C5': '4', 'C6': '1', 'C7': '8', 'C8': '7', 'C9': '2', 'D1': '9',
                           'D2': '6', 'D3': '2', 'D4': '1', 'D5': '8', 'D6': '3', 'D7': '5', 'D8': '4', 'D9': '7', 'E1': '3',
                           'E2': '5', 'E3': '8', 'E4': '4', 'E5': '9', 'E6': '7', 'E7': '2', 'E8': '1', 'E9': '6', 'F1': '1',
                           'F2': '4', 'F3': '7', 'F4': '2', 'F5': '5', 'F6': '6', 'F7': '3', 'F8': '9', 'F9': '8', 'G1': '8',
                           'G2': '3', 'G3': '6', 'G4': '7', 'G5': '1', 'G6': '5', 'G7': '4', 'G8': '2', 'G9': '9', 'H1': '2',
                           'H2': '7', 'H3': '5', 'H4': '9', 'H5': '6', 'H6': '4', 'H7': '1', 'H8': '8', 'H9': '3', 'I1': '4', 'I2': '1',
                           'I3': '9', 'I4': '8', 'I5': '3', 'I6': '2', 'I7': '7', 'I8': '6', 'I9': '5'}    
    
    def test_solve(self):
        self.assertEqual(solution.solve(self.diagonal_grid), self.solved_diag_sudoku)

    def test_solve2(self):
        self.assertEqual(solution.solve(self.diagonal_grid_2), self.solved_diag_sudoku2)

    def test_solve3(self):
        self.assertEqual(solution.solve(self.diagonal_grid_3), self.solved_diag_sudoku3)
